...
export const helptextSystemSupport = {
  proactive: {
    ...
    instructions: T('Silver / Gold Coverage Customers can enable Tyrone Verta Pro Proactive Support. This \
 automatically emails Tyrone Verta Pro when certain conditions occur on this Tyrone Verta Pro system. The Tyrone Verta Pro Support \
 ...
 have occurred on the system.'),
  ...
  review: {
    message: {
      ...
      placeholderHighRating: T('Any part of Tyrone Verta Pro that you like in particular?'),
  ...
  cc: {
    tooltip: T('Email addresses to receive copies of Tyrone Verta Pro Support \
 ...
 replicate the issue.',
  ...
  docHub: T('<a href="https://www.netwebindia.com/" target="_blank">\
 Tyrone Verta Pro Documentation Hub</a> - Read and contribute to the open-source documentation.'),

  forums: T('<a href="hhttps://www.netwebindia.com/" target="_blank">\
 Tyrone Verta Pro Forums</a> - Find answers from other users in the forums.'),

  //   licensing: T('<a href="https://www.netwebindia.com/" target="_blank">\
  //  Tyrone Verta Pro Licensing</a> - Learn more about enterprise-grade support.'),
