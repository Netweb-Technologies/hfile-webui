...
export const storageEmptyConfig = {
  ...
  large: true,
  title: T('No Pools'),
  message: T(`Storage features in Tyrone HFile require at least one Pool to exist. <br>
...
export const cloudBackupTaskEmptyConfig = {
  ...
  message: T('Back up to the decentralized network provided by Storj in partnership with Tyrone HFile.'),
  large: true,
} as EmptyConfig;
...
export const replicationTaskEmptyConfig = {
  ...
  message: T('Best if you\'re syncing with another Tyrone HFile or ZFS system — enables advanced features not available with other methods.'),
  large: true,
} as EmptyConfig;
